...
public class ProgramPackageImpl extends EPackageImpl implements ProgramPackage {
	 ...
	 * @see Program.ProgramPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
			...
			(theProgramPackage,
			 new EValidator.Descriptor() {
				 ...
				 public EValidator getEValidator() {
					 return ProgramValidator.INSTANCE;
				 }
			 });
	 ...
	 */
	@Override
	public EAttribute getProgram_Year() {
	...
	public void createPackageContents() {
		...
		createEAttribute(programEClass, PROGRAM__YEAR);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getProgram_Year(), ecorePackage.getEFloat(), "year", null, 0, 1, Program.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDepartment_Programs(), this.getProgram(), null, "programs", null, 1, -1, Department.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void create_1Annotations() {
		...
		addAnnotation
		  (semesterEClass,
		   source,
		   new String[] {
			   "min30Credits", "self.semesterCourses.course.credit -> sum()  >= 30.0"
		   });
		addAnnotation
		  (courseEClass,
		   source,
